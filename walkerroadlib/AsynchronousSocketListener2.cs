...
namespace walkerroadlib
{
    ...
    public class AsynchronousSocketListener2
    {
        ...
        public AsynchronousSocketListener2()
        {
        }
        ...
        public void AcceptCallback(IAsyncResult ar)
        {
            ...
            var res = handler.BeginReceive(state.buffer, 0, StateObject.BufferSize, 0, new AsyncCallback(state.ReadCallback), state);
        }
